package com.github.boyarsky1997.java8.exercise19;
...
public class Main {
    public static void main(String[] args) {
        ...
        Map<String, Optional<City>> collect = countries.stream()
                .collect(Collectors.toMap(Country::getName, o -> o.getCities()
                        .stream()
