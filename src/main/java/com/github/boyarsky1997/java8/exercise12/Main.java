package com.github.boyarsky1997.java8.exercise12;
...
public class Main {
    public static void main(String[] args) {
        ...
        Map<Customer, Map<Month, List<Order>>> collect = orders.stream()
                .collect(Collectors.groupingBy(Order::getCustomer, Collectors.groupingBy(o -> o.getOrderDate().getMonth())));
    }
}
